...
SPLIT_FILES = {
    ...
    # 'test': ['Artificial_CLine_test.json', 'Natural_CLine_test.json', 'Straight_CLine_test.json']
    # 'test': ['Straight_CLine_test.json']
    # 'test': ['Natural_CLine_test.json']
    'test': ['test.json']
}
